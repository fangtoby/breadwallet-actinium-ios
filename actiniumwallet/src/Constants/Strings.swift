...
enum S {
    ...
    enum Scanner {
        static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value:"Camera Flash", comment: "Scan Actinium address camera flash toggle")
    }
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value:"ACM Wallet is not allowed to access the camera", comment: "Camera not allowed alert title")
        ...
        enum UsedAddress {
            ...
            static let firstLine = NSLocalizedString("Send.UsedAddress.firstLine", value: "Actinium addresses are intended for single use only.", comment: "Adress already used alert message - first part")
        ...
        static let legacyAddressWarning = NSLocalizedString("Send.legacyAddressWarning", value: "Warning: this is a legacy Actinium address. Are you sure you want to send Bitcoin Cash to it?", comment: "Attempting to send to ")
    }
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access ACM Wallet's keychain data and steal your Actinium! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access ACM Wallet's keychain data and steal your Actinium. Please only use ACM Wallet on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = NSLocalizedString("UnlockScreen.touchIdPrompt", value:"Unlock your ACM Wallet.", comment: "TouchID/FaceID prompt text")
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value:"Protects your ACM Wallet from unauthorized users.", comment: "PIN button description")
            static let touchIdTitle = NSLocalizedString("SecurityCenter.touchIdTitle", value:"Touch ID", comment: "Touch ID button title")
            static let touchIdDescription = NSLocalizedString("SecurityCenter.touchIdDescription", value:"Conveniently unlock your ACM Wallet and send money up to a set limit.", comment: "Touch ID/FaceID button description")
            static let paperKeyTitle = NSLocalizedString("SecurityCenter.paperKeyTitle", value:"Paper Key", comment: "Paper Key button title")
            static let paperKeyDescription = NSLocalizedString("SecurityCenter.paperKeyDescription", value:"The only way to access your Actinium if you lose or upgrade your phone.", comment: "Paper Key button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value:"Your PIN will be used to unlock your ACM Wallet and send money.", comment: "PIN creation info.")
        ...
        static let caption = NSLocalizedString("UpdatePin.caption", value:"Remember this PIN. If you forget it, you won't be able to access your Actiniums.", comment: "Update PIN caption text")
    ...
    enum RecoverWallet {
        ...
        static let intro = NSLocalizedString("RecoverWallet.intro", value:"Recover your ACM Wallet with your paper key.", comment: "Recover wallet intro")
    ...
    enum OneTimeWipe {
        ...
        static let intro = NSLocalizedString("OneTimeWipe.intro", value:"Recover your ACM Wallet with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value:"My ACM Wallet", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let label = NSLocalizedString("TouchIdSettings.label", value:"Use your fingerprint to unlock your ACM Wallet and send money up to a set limit.", comment: "Touch Id screen label")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value:"Enable Touch ID for ACM Wallet", comment: "Touch id switch label.")
    ...
    enum FaceIDSettings {
        ...
        static let label = NSLocalizedString("FaceIDSettings.label", value:"Use your face to unlock your ACM Wallet and send money up to a set limit.", comment: "Face Id screen label")
        static let switchLabel = NSLocalizedString("FaceIDSettings.switchLabel", value:"Enable Face ID for ACM Wallet", comment: "Face id switch label.")
    ...
    enum Settings {
        ...
        static let currencyPageTitle = NSLocalizedString("Settings.currencyPageTitle", value: "%1$@ Settings", comment: "Actinium Settings page title")
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying ACM Wallet?", comment: "Are you enjoying ACM Wallet alert message body")
    ...
    enum PushNotifications {
        ...
        static let body = NSLocalizedString("PushNotifications.body", value:"Turn on notifications to receive special messages from ACM Wallet in the future.", comment: "Push notifications settings view body")
    ...
    enum DefaultCurrency {
        ...
        static let bitcoinLabel = NSLocalizedString("DefaultCurrency.bitcoinLabel", value: "Actinium Display Unit", comment: "Actinium denomination picker label")
    }
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the network but not in your ACM Wallet.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = NSLocalizedString("ShareData.body", value:"Help improve ACM Wallet by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum StartPaperPhrase {
        static let body = NSLocalizedString("StartPaperPhrase.body", value:"Your paper key is the only way to restore your ACM Wallet if your phone is lost, stolen, broken, or upgraded.\n\nWe will show you a list of words to write down on a piece of paper and keep safe.", comment: "Paper key explanation text.")
    ...
    enum RequestAnAmount {
        static let title = NSLocalizedString("RequestAnAmount.title", value:"Request an Amount", comment: "Request a specific amount of Actinium")
    ...
    enum MenuButton {
        ...
        static let buy = NSLocalizedString("MenuButton.buy", value:"Buy Actinium", comment: "Buy Actinium title")
    }
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the ACM Wallet iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "ACM Wallet has upgraded to using a 6-digit PIN. Tap Continue to upgrade.", comment: "Upgrade PIN prompt body.")
        }
        ...
        enum ShareData {
            ...
            static let body = NSLocalizedString("Prompts.ShareData.body", value: "Help improve ACM Wallet by sharing your anonymous data with us", comment: "Share data prompt body")
        }
        enum FaceId {
    ...
    enum PaymentProtocol {
        enum Errors {
            ...
            static let smallPayment = NSLocalizedString("PaymentProtocol.Errors.smallPayment", value: "Actinium payments can't be less than %1$@.", comment: "Amount too small error message")
            static let smallTransaction = NSLocalizedString("PaymentProtocol.Errors.smallTransaction", value: "Actinium transaction outputs can't be less than %1$@.", comment: "Output too small error message.")
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "ACM Wallet does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your ACM Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your ACM Wallet using a single transaction.", comment: "Import wallet intro screen message")
        ...
        static let confirm = NSLocalizedString("Import.confirm", value: "Send %1$@ from this private key into your wallet? The Actinium network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your Actinium wallet", comment: "<sitename> is requesting authentication using your Actinium wallet")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different ACM Wallet on this device.", comment: "Start wipe wallet view message")
    ...
    enum NodeSelector {
        ...
        static let title = NSLocalizedString("NodeSelector.title", value: "Actinium Nodes", comment: "Node Selector view title")
    ...
    enum Welcome {
        static let title = NSLocalizedString("Welcome.title", value: "Welcome to ACM Wallet!", comment: "Welcome view title")
